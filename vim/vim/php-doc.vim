...
let g:pdv_cfg_Package = "Insenz"
let g:pdv_cfg_Version = "//autogen//"
let g:pdv_cfg_Author = ""
let g:pdv_cfg_Copyright = "Copyright (C) 2008 eZ systems as. All rights reserved."
...
" TOB: let g:pdv_cfg_Author = "Tobias Schlitt <panrui@php.net>"
" TOB: let g:pdv_cfg_Copyright = "1997-2008 The PHP Group"
...
func! PhpDocClass()
	...
	" add by panrui 2008-02-20	
	exe l:txtBOL . g:pdv_cfg_Commentn . "  作者:  " . g:pdv_cfg_Author . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . "  创建时间: " . g:pdv_cfg_Time . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . "  修改记录: " . g:pdv_cfg_Report . g:pdv_cfg_EOL
    exe l:txtBOL . g:pdv_cfg_Commentn . g:pdv_cfg_EOL
	exe l:txtBOL . g:pdv_cfg_Commentn . " $Id$" 
